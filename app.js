...
app.use(function (req, res, next) {
  res.setHeader(
    ...
    "default-src 'self' firebasestorage.googleapis.com *.firebasestorage.googleapis.com; img-src * 'self' data: https:;font-src *; object-src 'self';script-src 'self' 'unsafe-inline' cdn.jsdelivr.net *.cdn.jsdelivr.net;style-src 'self' 'unsafe-inline' cdnjs.cloudflare.com *.cdnjs.cloudflare.com fontawesome.com *.fontawesome.com fonts.google.com *.fonts.google.com fonts.googleapis.com *.fonts.googleapis.com;"
  );
  next();
});
